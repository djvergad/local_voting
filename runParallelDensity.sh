...
rm output_density
parallel --gnu --sshloginfile <(~/scripts/build_sshlogin.sh) --workdir $PWD ./runOnce.sh {1} {2} {3} {4} {5} {6} {7} ::: 100 ::: 10 ::: 10 20 50 100 200 500 1000 ::: 10 ::: {30..1} ::: Simple LocalVoting LQF DRAND Lyui Lobats ::: {1..500} >> output_density
